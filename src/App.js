...
const CSS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .bubble-me{background:${C.accent};color:#fff;border-radius:18px 18px 4px 18px;padding:10px 14px;font-size:14px;line-height:1.5;word-break:break-word;max-width:65%;min-width:48px;text-align:left}
  .bubble-them{background:${C.surface};border:1px solid ${C.hairline};color:${C.ink};border-radius:18px 18px 18px 4px;padding:10px 14px;font-size:14px;line-height:1.5;word-break:break-word;max-width:65%;min-width:48px;text-align:left}
