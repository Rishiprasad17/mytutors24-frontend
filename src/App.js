...
const CSS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .bubble-me{min-width:44px;background:${C.accent};color:#fff;border-radius:18px 18px 4px 18px;padding:10px 14px;font-size:14px;line-height:1.5;max-width:65%;min-width:0;white-space:pre-wrap;word-wrap:break-word;text-align:left}
  .bubble-them{min-width:44px;background:${C.surface};border:1px solid ${C.hairline};color:${C.ink};border-radius:18px 18px 18px 4px;padding:10px 14px;font-size:14px;line-height:1.5;max-width:65%;min-width:0;white-space:pre-wrap;word-wrap:break-word;text-align:left}
